...
},
{
  ...
  options: ["Hummingbirds are the fastest birds.","The physical delicacy of hummingbirds hides their toughness.","Migration is the most dangerous event for hummingbirds.","People misunderstand hummingbirds."],
...
},
{
  ...
  options: ["Students listening to metal scored lower.","Brain scans showed lower activity in distraction centers.","Students enjoyed lo-fi music.","The study lasted six months."],
...
},
{
  ...
  answer: "1842,",
  explanation: "A comma closes the appositive phrase.",
  section: "English"
},
{
  question: "Urban parks filter pollutants and reduce heat. What is the purpose of the passage?",
  options: ["Argue for park funding","Compare bird species","Highlight ecological importance","Explain heat island formation"],
...
},
{
  ...
  options: ["Protein dieters felt fuller.","Carb dieters lost more weight.","Protein dieters retained more lean muscle.","Both lost equal fat."],
...
},
{
  ...
  options: ["Example supporting a claim","Counterargument","Scientific summary","Definition"],
...
},
{
  ...
  options: ["domestic subjects","paintings of children","bold lines inspired by Japanese prints","Impressionist style"],
...
},
{
  ...
  options: ["Explain how presses work","Argue the press had major impact","List Renaissance books","Explain censorship"],
...

{
  ...
  options: ["12","24","26","38"],
  answer: "26",
  explanation: "Solve for x: 3x = 12, so x = 4. Then 6(4) + 2 = 26.",
  section: "Math"
},
{
...
},
{
  ...
  answer: "3x²+2x+3",
  explanation: "Combine like terms: (2+1)x² + (3−1)x + (−5+8) = 3x²+2x+3.",
  section: "Math"
},
{
  question: "A bag has 5 red, 3 blue, 2 green marbles. What is P(not blue)?",
  options: ["3/10","1/2","7/10","4/5"],
  answer: "7/10",
  explanation: "7 non-blue marbles out of 10 total.",
  section: "Math"
},
{
  question: "What is the slope of the line through (0, 4) and (2, 10)?",
  options: ["2","3","4","6"],
  answer: "3",
...
},
{
  ...
  options: ["5","8","10","12"],
  answer: "8",
  explanation: "2x − 6 + 4 = 14 → 2x − 2 = 14 → x = 8.",
  section: "Math"
},
{
  question: "Which is a factor of x² − 7x + 10?",
  options: ["x−5","x+5","x−7","x+2"],
  answer: "x−5",
  explanation: "x² − 7x + 10 = (x − 5)(x − 2).",
  section: "Math"
},
{
  question: "A line has slope −2 and passes through (3, 4). What is the y-intercept?",
  options: ["2","6","10","14"],
  answer: "10",
  explanation: "y = mx + b → 4 = −2(3) + b → b = 10.",
  section: "Math"
},
{
  question: "A circle has area 16π. What is its circumference?",
  options: ["4π","8π","16π","32π"],
  answer: "8π",
  explanation: "Area = πr² = 16π → r = 4. Circumference = 2πr = 8π.",
  section: "Math"
},
{
  question: "Solve: 3^(n − 1) = 27",
  options: ["2","3","4","5"],
  answer: "4",
  explanation: "27 = 3³, so n − 1 = 3, meaning n = 4.",
  section: "Math"
},
{
  question: "Data set {4, 8, 8, 10, 15}. A value of 25 is added. Which measure increases the most?",
  options: ["Mean","Median","Mode","Range"],
  answer: "Range",
  explanation: "Range increases from 11 to 21. Mean barely shifts, median and mode don't change.",
  section: "Math"
},
{
...
},
{
  ...
  options: ["8","10","12","15"],
  answer: "12",
  explanation: "Pythagorean theorem: 5² + b² = 13² → 25 + b² = 169 → b = 12.",
  section: "Math"
},
{
  question: "f(x) = 2x² − 3x + 1. What is f(−2)?",
  options: ["1","3","11","15"],
  answer: "15",
  explanation: "2(4) − 3(−2) + 1 = 8 + 6 + 1 = 15.",
  section: "Math"
},
{
  question: "100 students: 60 like pizza, 40 like burgers, 20 like both. How many like neither?",
  options: ["0","10","20","40"],
  answer: "20",
  explanation: "60 + 40 − 20 = 80 like at least one. 100 − 80 = 20 neither.",
  section: "Math"
},
{
  question: "sin(A) = 3/5. What is cos(A)?",
  options: ["2/5","3/4","4/5","5/3"],
  answer: "4/5",
  explanation: "Using a 3-4-5 right triangle: cos(A) = adjacent/hypotenuse = 4/5.",
  section: "Math"
},
{
  question: "How many solutions does the system 2x + 3y = 8 and 4x + 6y = 16 have?",
  options: ["Zero","One","Two","Infinitely many"],
  answer: "Infinitely many",
  explanation: "The second equation is exactly double the first — they are the same line.",
  section: "Math"
},
{
  question: "What is the vertex of y = (x − 4)² + 7?",
  options: ["(4,7)","(-4,7)","(4,-7)","(7,4)"],
  answer: "(4,7)",
  explanation: "Vertex form y = (x − h)² + k gives vertex (h, k) = (4, 7).",
  section: "Math"
},
{
  question: "A rental car costs $40 plus $0.20 per mile. The total bill is $64. How many miles were driven?",
  options: ["80","100","120","140"],
  answer: "120",
  explanation: "0.20x = 64 − 40 = 24 → x = 120.",
  section: "Math"
},
{
  question: "What is the surface area of a rectangular prism with dimensions 4 × 3 × 5?",
  options: ["47","60","94","120"],
  answer: "94",
  explanation: "SA = 2(lw + lh + wh) = 2(12 + 20 + 15) = 2(47) = 94.",
  section: "Math"
}
